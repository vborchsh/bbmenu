...
#define QUICKUSB_ERROR_FILE_NAME                42
#define QUICKUSB_ERROR_ACCESS_DENIED            43
#define QUICKUSB_ERROR_SHARING_VIOLATION        44
...
// Streaming To/From file flags
#define QUICKUSB_STREAM_CREATE_ALWAYS            0x0001
#define QUICKUSB_STREAM_LOOP_AT_EOF              0x0002
...
QUSBLIB QRETURN QuickUsbBulkAbort(
    QHANDLE      hDevice, 
    PQBULKSTREAM bulkStream
);
